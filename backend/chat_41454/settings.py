"""
Django settings for chat_41454 project.
...
WSGI_APPLICATION = 'chat_41454.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chat_41454 API",
    "DESCRIPTION": "API documentation for chat_41454 App",
    "VERSION": "v1",
}
